      ...
      <div className="sm:px-8 mt-9">
        <div className="mx-auto w-full max-w-7x1 lg:px-8">
          <div className="relative px-4 sm:px-8 lg:px-12">
            <div className="mx-auto max-w-2x1 lg:max-w-5x1">
              <div className="max-w-2x1">
                <h1 className="text-4x1 font-bold tracking-tight text-zinc-800 sm:text-5x1 dark:text-zinc-100">
                  Cat Engineer, software designer cat, begging cat
                </h1>
                <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
                  "I'm Green Eastin, a software developing cat that loves to eat
                  treats and play. When doing neither I am sitting at the side
                  of my owner staring at him intently."
                </p>
              ...
              <div className="flex flex-col gap-16">
                <article className="group relative flex flex-col items-start">
                  ...
                  <p className="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                    ...
                    aliqua. Ligula ullamcorper malesuada proin libero nunc
                    consequat interdum varius. Magna etiam tempor orci eu
                    lobortis. Elit sed vulputate mi sit amet mauris commodo.
                    Nascetur ridiculus mus mauris vitae ultricies leo integer.
                    Vitae turpis massa sed elementum tempus. Eleifend mi in
